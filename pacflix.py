...
class pacflix():
    ...
    def __init__(self, user_name):
        ...
        print(f"Your account successfully created, share this code '{self.user_name}' to get some benefits.")
    ...
    def list_plan(self):
        ...
        print("HD, 2 device, Movie + sports, Rp 160.000,-.")
        print()
        print("3. Premium Plan.")
        print("UHD, 4 device, Movie + sports + Original, Rp 200.000,-.")
        ...
        if(subs_time.days > 360):
            if(self.current_plan == "Basic Plan"):
                if(new_plan == "Standard Plan"):
                    ...
                    self.current_plan = "Premium Plan"
                    total_price =(200_000 -(2000_000*0.05))
                    print(f"Upgrade to {self.current_plan}, price + discount = {total_price}.")
